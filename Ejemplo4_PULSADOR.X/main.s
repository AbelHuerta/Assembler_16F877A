...
;Establece TRISB como entrada(1)
    BSF TRISB,7
...
;Establecer PORTB encendido(1),apagado(0)
    ...
    BTFSS   PORTB,7	    ;SI VALE 1 EL BIT 7, SALTA 1 INSTRUCCION
    GOTO    $-1		    ;BUCLE CON BTFSS HASTA QUE SE PRESIONE 
    BSF	    PORTB,0	    ;RB0 ENCENDIDO
    BTFSC   PORTB,7	    ;SI VALE 0 EL BIT 7, SALTA 1 INSTRUCCION
    GOTO    $-1		    ;BUCLE CON BTFSC HASTA QUE SE SUELTE 
